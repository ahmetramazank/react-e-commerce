    ...
    <div className='flex gap-10 my-10'>
        ...
        <div className=''>
            ...
            <div className='flex items-center gap-5 my-4'>
              ...
              <input className='w-10 text-center text-3xl font-bold' type="text" value={quantity} />
              <div onClick={increment} className='text-4xl cursor-pointer'>+</div>
            </div>
            <div onClick={addBasket} className='border w-[200px] text-2xl rounded-md bg-gray-200 my-4 cursor-pointer h-16 flex items-center justify-center'>Sepete Ekle</div>
        </div>
    </div>
  )
}
